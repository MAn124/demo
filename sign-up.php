...
<body>
    ...
    <?php 
        ...
        if(isset($_POST['signup_btn'])) {
            ...
            $sql = "INSERT INTO user ( name, useremail, userpassword) VALUES ('$username', '$email', '$pass');";
                                ...
                                <div class="card-body">
                                    ...
                                    <h2 class="m-b-0">Sign In</h2>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="checkpass" type="password" class="form-control" id="confirmPassword" placeholder="Confirm Password">
                                        </div>
                                        <div class="form-group">
                                            <div class="d-flex align-items-center justify-content-between p-t-15">
                                                ...
                                                <button name="signup_btn" class="btn btn-primary">Sign Up</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
